...
export default function Product({isAuth}) {
    ...
    return (
        <>
            <View style={[styles.container, {paddingTop: 0, paddingBottom: 0, transform: [{translateY: -15}], backgroundColor: 'rgba(119, 31, 152, 0.63)'}]}>
            ...
            <View style={[styles.products, {transform: [{translateY: -15}]}]}>
                <Text component={Link} to={''} style={[styles.products__text, styles.products__text__purple]}>Cards</Text>
                <Text component={Link} to={''} style={[styles.products__text]}>Navigation</Text>
                <Text component={Link} to={''} style={[styles.products__text, styles.products__text__purple]}>Video</Text>
                <Text component={Link} to={''} style={[styles.products__text]}>Audio</Text>
                <Text component={Link} to={''} style={[styles.products__text, styles.products__text__purple]}>Test</Text>
                <Text component={Link} to={''} style={[styles.products__text]}>Useful links</Text>
            </View> 
        </>
    )
}
